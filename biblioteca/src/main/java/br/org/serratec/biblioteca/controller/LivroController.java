...
public class LivroController {
	...
	public ResponseEntity<Livro> buscarPorId(@RequestParam String isbn) {
	...
	public ResponseEntity<List<LivroCategoriaDTO>> listaLivroCategoria(){
		return ResponseEntity.ok(livroRepository.listaLivroCategoria());
	}
	
	@GetMapping("/relatorio-autores")
	public ResponseEntity<List<AutorTotalLivrosDTO>> listaTotalLivroAutor(){
		return ResponseEntity.ok(livroRepository.listaTotalLivrosAutor());
	}
	
	@GetMapping("/busca-categoria")
	public ResponseEntity<List<Livro>> buscaPorCategoria(@RequestParam String categoria) {
		return ResponseEntity.ok(livroRepository.listaPorCategoria(categoria));
	}
